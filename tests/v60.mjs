...
ok('poids réduit de moitié en mots (192 vs 367)', words()<250 && nb()<=38);
ok('résumé du contexte visible replié', w5.document.getElementById('app').innerHTML.includes('Standard'));
ok('résumé des mécaniques visible replié', w5.document.getElementById('app').innerHTML.includes('8/8'));
w5.S.qc4=true; w5.S.qc5=true; w5.render();
ok('déplié : tout revient', words()>330);
