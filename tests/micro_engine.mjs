...
w.setMicroStyle('voiture'); ok('En voiture → CONTEXTE=VOITURE_BRUIT', w.briefText().includes('CONTEXTE=VOITURE_BRUIT'));
w.setMicroStyle('express'); ok('Express → CADENCE=RAPIDE + objectif 8', w.briefText().includes('CADENCE=RAPIDE') && w.briefText().includes('OBJECTIF=8'));
